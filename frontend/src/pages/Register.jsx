  ...
  const navigate = useNavigate();
    ...
    const submitHandler = async (e) => {
        ...
        if(password.length<5){
          toast.error('Password length must be grerter then five!!');
          return;
        }
        ...
        <div className="form-groups">
          <form className="form" onSubmit={submitHandler}>
            ...
            <div className="form-group">
              ...
              <input type="email" onChange={(e) => setEmail(e.target.value)} className='input' id='email' required />
            </div>
            <div className="form-group">
              <label htmlFor="mobile">Mobile Number</label>
              <input type="text" onChange={(e) => setMobile(e.target.value)} className='input' id='mobile' required />
            </div>
